...
from sherpa.astro.ui import set_model, load_pha, set_stat, ignore, notice, load_rmf, load_arf, get_model_component, get_model, get_model_pars, thaw, plot_fit
...
mdl.norm.max = 1  # Set max for norm
