...
class annulus:
    ...
    def __init__(self,r_in,r_out):
        ...
        self.Da = 0
        self.dl = 0
    def add_fit_data(self,temp,temp_min,temp_max,abund,abund_min,abund_max,norm,norm_min,norm_max,flux,flux_min,flux_max,reduced_chi_sq,agn,deproj,redshift):
