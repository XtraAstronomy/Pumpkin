...
class region:
    ...
    def __init__(self, bin_num):
        ...
        self.Da = 0
        self.dl = 0
    def add_fit_data(self,temp,temp_min,temp_max,abund,abund_min,abund_max,norm,norm_min,norm_max,reduced_chi_sq,redshift):
        ...
        #self.flux = [flux,flux_min,flux_max]
    ...
    def save_data(self,file_to_write,file_min,file_max):
        ...
        if self.agn_act == True:
            agn_corr = 'yes'
        file_to_write.write(str(self.bin_num) + "," + str(self.temp[1]) + "," + str(self.abund[1])+ "," + str(self.dens[1])+ "," + str(self.press[1])
            + "," + str(self.entropy[1])+"\n")
